...
function initVariableBeatUp() {
  ...
  // A prior playthrough may have left one of these mid-cycle-hidden (see the
  // hide()/show() pairs in moveLeftUp() etc.) - force them all visible again
  // since this page never reloads between runs the way the original site did.
  ["left-up-beat-up", "right-up-beat-up", "left-beat-up", "right-beat-up", "left-down-beat-up", "right-down-beat-up"].forEach(show);
}
